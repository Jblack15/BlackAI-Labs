...
export const SMS_SEQUENCE=[
  ...
  (name:string,address:string)=>`Hi ${name}, just following up about ${address}. If selling is on your mind, we can provide a no-obligation cash offer. Reply here with any questions.`,
