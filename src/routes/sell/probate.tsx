...
const content: SellerLandingProps = {
  ...
  description:
    "Inheriting a property can be more burden than blessing — especially when it needs work, is out of state, or when multiple heirs can't agree. DealForge Properties makes it simple: we buy inherited properties as-is for cash, so you can settle the estate and move on.",
  whyDealFlow:
...
export const Route = createFileRoute("/sell/probate")({
  head: () => ({
    meta: [
      { title: "Inherited a House? Sell It Fast For Cash — DealForge Properties" },
      {
        name: "description",
        content:
