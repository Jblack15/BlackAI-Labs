...
const content: SellerLandingProps = {
  ...
  description:
    "Divorce is hard enough without the added stress of selling a house. DealForge Properties provides a fast, clean sale so both parties can divide the proceeds and move forward. No repairs, no showings, no delays — just a fair cash offer and a quick close.",
  whyDealFlow:
...
export const Route = createFileRoute("/sell/divorce")({
  head: () => ({
    meta: [
      { title: "Divorce Sale? Sell Fast For Cash — DealForge Properties" },
      {
        name: "description",
        content:
