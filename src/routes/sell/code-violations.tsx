...
const content: SellerLandingProps = {
  ...
  description:
    "Code violations can make a property nearly impossible to sell through traditional channels. Agents won't list it, lenders won't finance it, and buyers run away. DealForge Properties buys properties with code violations as-is — we handle the fixes after closing.",
  whyDealFlow:
...
export const Route = createFileRoute("/sell/code-violations")({
  head: () => ({
    meta: [
      { title: "Code Violations? We Buy As-Is — DealForge Properties" },
      {
        name: "description",
        content:
